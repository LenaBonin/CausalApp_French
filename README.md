<b>CausalApp </b> is an app to support researchers in doing a causal or mediation analysis. It is specifically designed for social epidemiologists but can be used by researchers from other fields as well.
